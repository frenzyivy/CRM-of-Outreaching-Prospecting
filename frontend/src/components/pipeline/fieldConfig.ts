...
export type LeadField   = 'job_title' | 'company' | 'email' | 'phone' | 'city_country' | 'source' | 'linkedin' | 'instagram' | 'facebook' | 'twitter' | 'notion_url' | 'created_at'
...
export const LEAD_FIELDS: Record<LeadField, FieldDef> = {
  ...
  instagram:   { label: 'Instagram',  defaultOn: false },
  facebook:    { label: 'Facebook',   defaultOn: false },
  twitter:     { label: 'Twitter',    defaultOn: false },
