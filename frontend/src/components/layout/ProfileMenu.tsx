  ...
  return (
    <>
      <div ref={ref} className="relative">
        ...
        {/* Dropdown - pops to the right of the sidebar */}
        {open && (
          <div className="absolute bottom-0 left-full ml-3 w-72 bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden z-50">
            {/* Profile Header */}
